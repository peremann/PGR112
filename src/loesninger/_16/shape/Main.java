...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            Circle c = shapeService.addCircle(Color.BLACK, true, 2.5, new MovablePoint());
        ...
        /*
        Circle c = new Circle(1, Color.BLACK, true, 2.5, new MovablePoint());
        System.out.println(c);
        ...
        Rectangle r = new Rectangle(2, Color.BLUE, false, 3.2, 2.1, mp2, mp3);
